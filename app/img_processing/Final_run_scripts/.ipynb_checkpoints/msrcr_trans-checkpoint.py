...
def process_single_image(args):
    ...
    """
    input_image_path, input_mask_path, output_path, debug_output_folder, config = args
...
def collect_processing_tasks(image_folder, mask_folder, output_folder, debug_output_folder, config):
    tasks = []
    ...
    for img_filename in sorted(image_files):
        ...
        if mask_filename:
            ...
            tasks.append((img_path, mask_path, output_file_path, debug_output_folder, config))
        else:
...
if __name__ == "__main__":
    ...
    INPUT_IMAGE_FOLDER = "/home/projects/medimg/gnikhil/bg_remove/inference_results/149/" # Example: "/path/to/your/image/folder"
    INPUT_MASK_FOLDER = "/home/projects/medimg/gnikhil/bg_remove/inference_results/149/"  # Example: "/path/to/your/mask/folder"
    OUTPUT_FOLDER = "/home/projects/medimg/supriti/brain-registration/149/149_BFI/" # Updated output folder for transparent background
    ...
    tasks = collect_processing_tasks(INPUT_IMAGE_FOLDER, INPUT_MASK_FOLDER, OUTPUT_FOLDER, DEBUG_OUTPUT_FOLDER, processing_config)
